...
public class Resources {
    public static final String SOURCE_PACKAGES = "/org/sbsa/electronics/shop/";
    public static final String PACKAGE_MEDIA = "/images/";
    public static final String RIMOUSKI_FONT = "/fonts/rimouski.ttf";
    public static final String NO_IMAGE_AVAILABLE = "images/empty-image.jpg";
    public static final String CSS_LIGHT_THEME = "/css/LightTheme.css";
    public static final String LIGHT_THEME = Resources.class.getResource(CSS_LIGHT_THEME).toExternalForm();
    public static JFXDialog dialog;
    @Autowired
    private static DialogTransition dialogTransition;
    ...
    public static void showSuccessAlert(StackPane dialogContainer, Node nodeToBlur, Node nodeToDisable, String text) {
        ...
        JFXButton button = new JFXButton(PropertiesCache.getInstance().getProperty("bien"));
        ...
        Text textTitle = new Text(PropertiesCache.getInstance().getProperty("bien"));
        ...
        dialog.setTransitionType(dialogTransition.dialogTransition());
    ...
    public static void validationOfJFXTextField(JFXTextField txt) {
        ...
        validator.setMessage(PropertiesCache.getInstance().getProperty("champ.obligatoire"));
    ...
    public static void goToUrl(String url, Node node) {
